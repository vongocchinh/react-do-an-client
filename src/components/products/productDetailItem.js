            ...
            <div className="productDetail-main">
                ...
                <div className="product-detail-images">
                    ...
                    <div className="images-small">
                        ...
                        <img alt="###" src={"https://hiashi.vn/vnt_upload/product/nophoto.gif"} />
                        <img alt="###" src={"https://hiashi.vn/vnt_upload/product/nophoto.gif"} />
                    </div>
                    </div>
                </div>
                ...
                <div className="product-detail-name">
                    <p className="product-detail-name-h1">{data.name}</p>
                    ...
                    <p className="total-comment-detail-product">Đánh giá: <span>3600 đánh giá sản phẩm</span>.</p>
                    <h4 className="product-detail-price">Giá :&nbsp;<span>{Format.format_currency(Format.priceSale(data.price,data.priceSale))} vnd</span></h4>
                    <hr></hr>
                    <p className="product-detail-status">Tình trạng: <span>{Format.status(data.statusQuantity)}</span></p>
                    ...
                    <p className="online-phone">Gọi đặt mua: <span className="color-red">19006750</span> (8:00 - 22:00)</p>
                </div>
                </div>
            </div>
